...
export class OmComponent implements OnInit {
  ...
  displayedColumns: string[] = ['choose', 'approve', 'notapprove', 'info','diff','docType','accDocNo','fiscYear'
  ,'referenceNo','referenceText','dateDoc','datePost','test1','test2','test3','test4','test5','test6','test7','test8',
